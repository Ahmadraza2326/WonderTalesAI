...
import { MemoryMuseum } from '../components/playroom/stations/MemoryMuseum'
...
export const MemoryMuseumPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="memory-museum-page-wrapper"
        style={{
          flex: 1,
          display: 'flex',
          flexDirection: 'column',
...
export default MemoryMuseumPage
