...
import { EcosystemSandbox } from '../components/playroom/stations/EcosystemSandbox'
...
export const EcosystemSandboxPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="ecosystem-sandbox-page-wrapper"
        style={{
          flex: 1,
          display: 'flex',
          flexDirection: 'column',
